...
export const fetchProducts = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "http://localhost:3000/products/getproductlist"
    );
    return response.data.products;
  }
);

export const fetchUniqueCategory = createAsyncThunk(
  "products/fetchUniqueCategory",
  async () => {
    const response = await axios.get(
      "http://localhost:3000/products/fetchCategoryByNameID"
    );
...
export const fetchProductsByCategoryId = createAsyncThunk(
  ...
  async (subId) => {
    const response = await axios.get(
      `http://localhost:3000/products/fetchProductsByCategoryId/${subId}`
    );
...
export const fetchCategories = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "http://localhost:3000/products/fetchUniqueCategory"
    );
...
export const fetchDataBySectionId = createAsyncThunk(
  "products/fetchDataSectionId",
  async (sectionId) => {
    const response = await axios.get(
      `http://localhost:3000/products/fetchDataBySectionId/${sectionId}`
    );
